...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.mb-5(data-aos="fade-left")
      .col-12
        .titulo-sexto.color-acento-contenido.mb-4
          p.mb-0 #[b Figura 3.] Pasos para generar indicadores de gestión
        figure
    ...
    .row.justify-content-center.mb-5(data-aos="fade-up")
      .col-10.bg-c3.p-4
        .row.align-items-center.justify-content-center
          ...
          .col-lg.mb-4.mb-lg-0
            h4.mb-0 Metodologías y paso a paso de construcción de indicadores de gestión
            p.mb-0 Para profundizar en las #[b metodologías y el paso a paso de construcción de indicadores de gestión], lo invitamos a consultar el material complementario.
          .col-lg-auto
            a.boton.color-acento-botones(href="https://www.youtube.com/watch?v=5QGuWriJFh8" target="_blank" type="application/pdf")
    ...
    .row(data-aos="fade-left")
      .col-12
        .titulo-sexto.color-acento-contenido.mb-4
          p.mb-0 #[b Figura 4.] Pasos para elaborar el plan de mejoramiento
        figure
